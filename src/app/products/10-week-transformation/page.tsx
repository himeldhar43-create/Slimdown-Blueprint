...
export const metadata = {
  title: '10-Week Transformation Guide | Slimdown Blueprint',
  description: 'A complete nutrition and home workout system designed to help women build steady habits and long-term results.',
};

export default function TenWeekTransformationPage() {
  const inclusions = [
    "Full 10-Week Progressive Exercise Architecture",
    "Daily Food Strategy & Macro Balance Outlines",
    "Self-Reflective Habit Tracker & Logs",
    "Complete Movement Library & Instructionals",
    "Lifetime Document Revisions & Upgrades Included"
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-gray-500 text-sm md:text-base leading-relaxed">
              Our most comprehensive individual digital guide, engineered to help you adopt positive wellness routines, balance energy curves, and establish sustainable habits.
            </p>
            ...
            <div className="space-y-4">
              <h3 className="font-heading font-bold text-lg text-brand-dark">
                A Balanced, Progressive Method
              </h3>
              <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">
                Reaching long-term goals depends on clear daily patterns. This 10-week system introduces small, manageable adjustments over time, making it easier to integrate healthy changes into your daily life.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-5">
            <div className="bg-white border border-gray-100 shadow-premium rounded-3xl p-8 space-y-6 sticky top-28">
              ...
              <div className="flex items-baseline space-x-1 border-b border-gray-55 pb-6">
                <span className="text-4xl font-extrabold text-brand-dark">$19.99</span>
